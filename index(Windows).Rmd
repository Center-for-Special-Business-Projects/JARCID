...
# Please take note that this script will take a few hours to complete. It is best to run it at night. It needs further optimization but for now, the most time consuming tasks are generating a GeoJSON with Ottawa and Gatineau together and creating the maps from the building polygons. It can take from 5 to 8 hours to complete depending on the environment. 
...
write.csv(Build, 'C:/JARCID/Buildings.csv', row.names = F)
